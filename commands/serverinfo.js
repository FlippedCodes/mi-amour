...
module.exports.run = async (client, message, args, con, config) => {
  ...
  let embed = new MessageEmbed()
    ...
    .addField(lang.chat_command_serverinfo_embed_channels(), server.channels.cache.size, true)
    .addField(lang.chat_command_serverinfo_embed_emojis(), server.emojis.cache.size, true)
